...
*  @version  Release: $Revision: 15821M $
	...
	<form name="authorizeaim_form" id="authorizeaim_form" action="{$module_dir}validation.php" method="post">
		<span style="border: 1px solid #595A5E;display: block;padding: 0.6em;text-decoration: none;margin-left: 0.7em;">
			<a id="click_authorizeaim" href="#" title="{l s='Pay with AuthorizeAIM' mod='authorizeaim'}" style="display: block;text-decoration: none; font-weight: bold;">
				...
				<input type="text" name="name" id="fullname" size="30" maxlength="25S" style="width:50%" /><img src="{$module_dir}secure.png" alt="" style="margin-left: 5px;" /><br /><br />
				...
				<input type="text" name="x_card_num" id="cardnum" size="30" maxlength="16" autocomplete="Off"  style="width:50%"/><img src="{$module_dir}secure.png" alt="" style="margin-left: 5px;" /><br /><br />
				...
				<select id="x_exp_date_m" name="x_exp_date_m" style="width:60px;">{section name=date_m start=01 loop=13}
				 ...
				 /
				<select name="x_exp_date_y" style="width:40%">{section name=date_y start=11 loop=20}
				...
				<input type="text" name="x_card_code" id="x_card_code" size="4" maxlength="4"  style="width:50%"/><img src="{$module_dir}secure.png" alt="" style="margin-left: 5px;"/> <img src="{$module_dir}help.png" id="cvv_help" title="{l s='the 3 last digits on the back of your credit card' mod='authorizeaim'}" alt="" /><br /><br />
